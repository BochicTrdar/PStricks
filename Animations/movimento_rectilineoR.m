...
the_arrowR = [ '\psline[linewidth=5pt,linecolor=red]{->}(0,0)('  num2str(x(i)) ',' num2str(y(i)) ')']; 
...
! convert -delay 10 -loop 0 frame*.gif movimento_rectilineoR.gif
! animate movimento_rectilineoR.gif
