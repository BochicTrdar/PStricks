...
vector_coords = [ '\psline[linewidth=4pt,linecolor=red]{->}(0,0)' ]; 
...
system('mogrify -format gif frame.pdf');
       ...
       if i < 11
       eval(['system('mv frame.gif frame0' num2str(i-1) '.gif'])
       else
       eval(['system('mv frame.gif frame'  num2str( i ) '.gif'])
       end 
       
end 

system('convert -delay 15 -loop 0 frame*.gif movimento_circularR.gif');
system('animate movimento_circularR.gif');
