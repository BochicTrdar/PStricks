...
I made it for an introductory physics class to explain a common demonstration:   
if you aim a gun at a target held in the air, and fire the instant the target is dropped, you always hit the target, no matter how fast your bullet goes. There are a lot of numbers hard coded in, but it's not hard to alter the second example so that the initial velocity of the bullet is different.  You just change v0 and the number of frames (and the arrow representing v0).  I'm sure it can be made much more elegant.
\end{comment}
